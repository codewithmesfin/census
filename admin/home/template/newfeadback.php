    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
          <div class="col-12 col-lg-8 mx-auto">
            <form class="" action="../data/feadback.php" method="post">
              <div class="row">
                <div class="col-12">
                  <input type="text" name="title" value="" placeholder="Title" class="form-control" required>
                </div>
                <div class="col-12">
                  <input type="text" name="fullname" value="" placeholder="Your Name" class="form-control" required>
                </div>
                <div class="col-12">
                  <textarea name="feadbacks" rows="12"class="form-control" required placeholder="Feadback" style="max-height:400px;min-height:300px"></textarea>
                </div>
                <div class="col-12">
                  <input type="submit" name="feadback" value="Submit your Feadback" class="btn btn-secondary btn-block">
                </div>
              </div>
            </form>
          </div>
