                                      ...
                                      <?php
                                         class NewPerson
                                         {
                                           ...
                                           function newPerson()
                                           {
                                             ...
                                             $sql="SELECT * FROM newperson where user_id='$this->file_id'";
                                             $result_set=mysqli_query($obj->conn,$sql) or die(mysqli_connect_error($sql));
                                             while($row=mysqli_fetch_array($result_set))
                                             {
                                               ?>
                                               <form class="my-3" action="data/edit.php?id=<?php echo $row['user_id'] ?> &amp dbname=newuser" method="post">
                                                 <div class="row">
                                               ...
                                               <div class="col-12 col-lg-4 mx-auto form-group">
                                                 <input type="submit" name="newuser" value="Update User" class="btn btn-secondary">
                                               </div>
                                               <?php
                                             }
                                           }
