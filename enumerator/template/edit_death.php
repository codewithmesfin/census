                                      ...
                                      <?php
                                         class Death
                                         {
                                           ...
                                           function death()
                                           {
                                             ...
                                             $sql="SELECT * FROM death where user_id='$this->file_id'";
                                             $result_set=mysqli_query($obj->conn,$sql) or die(mysqli_connect_error($sql));
                                             while($row=mysqli_fetch_array($result_set))
                                             {
                                               ?>
                                               <form class="my-3" action="data/edit_death.php?id=<?php echo $row['user_id'] ?>" method="post">
                                                 <div class="row">
                                               ...
                                               <div class="form-group col-12 col-lg-6">
                                                 ...
                                                 <input type="text" name="death_cause" value="<?php echo $row['death_cause'] ?>" placeholder="e.g. Canada" class="form-control">
                                               </div>
                                               <div class="col-12 col-lg-6 form-group">
                                               ...
                                               <div class="col-12 col-lg-4 mx-auto form-group">
                                                 <input type="submit" name="death" value="Update User" class="btn btn-secondary">
                                               </div>
                                               <?php
                                             }
                                           }
