                                      ...
                                      <?php
                                         class Emigrator
                                         {
                                           ...
                                           function emigrator()
                                           {
                                             ...
                                             $sql="SELECT * FROM emigrator where user_id='$this->file_id'";
                                             $result_set=mysqli_query($obj->conn,$sql) or die(mysqli_connect_error($sql));
                                             while($row=mysqli_fetch_array($result_set))
                                             {
                                               ?>
                                               <form class="my-3" action="data/edit_emigrater.php?id=<?php echo $row['user_id'] ?> &amp dbname=newuser" method="post">
                                                 <div class="row">
                                               ...
                                               <div class="col-12 col-lg-6 form-group">
                                                 ...
                                                 <input type="date" name="edate" value="<?php echo $row['edate'] ?>" class="form-control">
                                               </div>
                                               <div class="form-group col-12 col-lg-6">
                                                 <label for="">Emigrated to</label>
                                                 <input type="text" name="emigratedto" value="<?php echo $row['emigratedto'] ?>" placeholder="e.g. Canada" class="form-control">
                                               </div>
                                               <div class="col-12 col-lg-6 form-group">
                                               ...
                                               <div class="col-12 col-lg-4 mx-auto form-group">
                                                 <input type="submit" name="emigrator" value="Update User" class="btn btn-secondary">
                                               </div>
                                               <?php
                                             }
                                           }
