                                      ...
                                      <?php
                                         class Imigrator
                                         {
                                           ...
                                           function imigrator()
                                           {
                                             ...
                                             {
                                               ?>
                                               <form class="my-3" action="data/edit_imigrater.php?id=<?php echo $row['user_id'] ?> &amp dbname=newuser" method="post">
                                                 <div class="row">
                                               ...
                                               <div class="form-group col-12 col-lg-6">
                                                 <label for="">Emigrated from</label>
                                                 <input type="text" name="imigratedfrom" value="<?php echo $row['imigratedfrom'] ?>" placeholder="e.g. Canada" class="form-control">
                                               </div>
                                               <div class="col-12 col-lg-6 form-group">
                                               ...
                                               <div class="col-12 col-lg-4 mx-auto form-group">
                                                 <input type="submit" name="imigrator" value="Update User" class="btn btn-secondary">
                                               </div>
                                               <?php
                                             }
                                           }
