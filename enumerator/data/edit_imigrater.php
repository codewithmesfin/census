...
include("config.php");
     function signup(){
       ...
       $imigratedfrom= mysqli_real_escape_string($obj->conn,$_POST['imigratedfrom']);
       $gender = mysqli_real_escape_string($obj->conn,$_POST['gender']);
       $reg_date=date("y-m-d");
       $sql_update="UPDATE imigrator SET
                             idno='$idno',
